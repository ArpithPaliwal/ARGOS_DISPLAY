...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/Mechatronics_03_placements_02"
        element={<Mechatronics_03_placements_02 />}
      />
      ...
      <Route
        path="/Mechatronics_projects_02"
        element={<Mechatronics_projects_02 />}
      />
