    ...
    <Layout>
      ...
      hover:shadow-blue-300/70 mt-6 mx-auto p-4">
        ...
        <div className="flex items-center justify-center">
          <img
            src="/mechatronics/arp (1).png" // replace with your actual image path
      ...
      <div className="text-center mt-6">
        ...
        px-6 py-3 rounded-2xl w-40 transition duration-300 hover:bg-blue-500">
          <Link to="/Mechatronics_ach_02">Next</Link>
        </button>
      </div>
    </Layout>
  )
...
export default Mechatronics_ach_01
